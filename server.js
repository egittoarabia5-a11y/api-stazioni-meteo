...
app.get('/netatmoLiguria.json', async (req, res) => {
  try {
    ...
    const tempCorrections = {
      ...
      "via casartelli": 2.0, "via san marino": 2.0, "via fra vince": 3.5,
      "via faenza": 1.5, "via milano": 1.0, "vico del fieno": 1.5,
      "salita re magi": 1.0, "piazzetta ninfeo": 1.0, "via paolo della cella": 1.0,
